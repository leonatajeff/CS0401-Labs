...
public class SimpleLList
{
	...
	// since the size is always exactly correct.
	public boolean add(String val)
	{
		...
		else
		{
			...
			// new node is then linked after the last node.  How could
	...
	public String toString() { // enhanced part 
		Node curr = front;
	...
	public boolean equals(SimpleLList arg) { //enhanced part 2
		if (this.size() == arg.size()) {
			Node curr = front;
			int i = 0;
			while(getNodeAt(i) != null) {
				curr = getNodeAt(i);
